...
insert into User (first_name, last_name, email, social_media, bio) values ('Hi', 'Burling', 'hburling0@unesco.org', '@CDFnBi', 'Mauris enim leo, rhoncus sed, vestibulum sit amet, cursus id, turpis. Integer aliquet, massa id lobortis convallis, tortor risus dapibus augue, vel accumsan tellus nisi eu orci. Mauris lacinia sapien quis libero.');
insert into User (first_name, last_name, email, social_media, bio) values ('Olivero', 'Neaverson', 'oneaverson1@arizona.edu', '@VRdnzv', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.
